...
elseif ( $ismntly || $isadmin || $isyearly ) { $access = true; }
	...
	if ( $post_life > 60 ) {
		...
		else : $errorlink = '<a href="#" data-reveal-id="modal-error-nonyr">Log In/Sign up <img class="hidden" src="'. get_stylesheet_directory_uri(). '/assets/img/right-arrow-small.png" /></a>'; endif;
