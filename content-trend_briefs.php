...
<div id="wire-rht">
	...
	<!--<div class="wire-backto">
		<a href="/index.html">Back to Reports <img style="margin-bottom:2px;" src="/wp-content/themes/twentythirteen-child/assets/img/icn-right-arrow-sm.png"/></a>
	</div>
	<ul class="wire-share">
		<li>Share to:</li>
...
//			if( $api->isTrendBriefSub() || current_user_can( 'read_private_posts' ) ) {
