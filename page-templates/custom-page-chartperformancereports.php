<?php
/**
 * Template Name: Chart Performing Hits
 *
 * Description: This is the chart performing hits page to the HSD website including sidebar
 *
 * @package WordPress
...
$args = array(
	'category__in' => array( 13,27,28,17,29,30 ),
	'posts_per_page' => 10,
	'paged' => $paged
);
