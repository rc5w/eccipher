<?php
/*
 * Template Name: On Demand Workshops
 * Template Post Type: workshops, ondemand
 */
...
<?php endif; ?>
	...
	if ( !has_term('free-articles', 'hsdwire_categories' ) ) {
		$api = am4PluginsManager::getAPI();
				if( $api->isVideoOnDemandSub() || $api->isWorkshopSub() || $api->isOnDemandSub() || current_user_can( 'read_private_posts' ) ) {
