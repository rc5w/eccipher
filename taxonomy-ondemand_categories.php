...
"pop1.screenpopper.com",{"Load":["738/2725/a19542161ff9dd69fb17a9780410723a"]});
	...
	<?php
	if ( has_term( 'videos-on-demand', 'ondemand_categories' ) ) {
			?>
			<h1>VIDEOS</h1>
			<?php
	}else{
...
function filter_where( $where = '' ) {
	...
	return $where;
		...
		<?php query_posts($query_string . '&cat=-1,-2,-3,-5,-6,-12,-15,-16,-19,-20.-21,-23,-25,-34,-35,-42,-43,-47,-48,-49,-50,-51,-52,-55,-56,-122,-128,-118,-227'); ?>
