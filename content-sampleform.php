...
<div class="hsdsample-box-form" style="margin-top: -30px;">
              ...
              <p style="width:100%; display:none;"> If you don't have an active subscription, please fill out the form below to receive one-week complimentary access to Hit Songs Deconstructed Reports and the<br> IMMERSION database.</p>
<div id="errorbox"></div>
            <form class="hsdlanding-sampleform" style="width:100%; display:none;">
              ...
              <!--  <label>Primary Occupation<sup style="color:#f35c2d;">*</sup></label> -->
                ...
                <input type="hidden" name="subscription_type" id="subscription_type" value="Individual - Sample Report">
              </form>
		...
		$.post(
			...
			function(msg) {
					...
					_ssstats.push([
						'publish',
						'Subscribe', {
							subscription: 'HSD_Immersion_Trial',
			    ...
			    $.post(
				   ...
				   id:msg
					...
					//$('.test-sample-report').css("display", "block"),
						window.location = "https://db.hitsongsdeconstructed.com/"; // was log-in-success
